    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('play_time', models.PositiveIntegerField(default=10, help_text='单位/秒', verbose_name='播放时间')),
            ],
            options={
                'verbose_name': '广告节目素材',
        ...
        migrations.CreateModel(
            name='PrimaryWelfareProgrammeRelated',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='materials.Machine')),
                ('programme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='materials.PrimaryWelfareProgramme')),
            ],
            options={

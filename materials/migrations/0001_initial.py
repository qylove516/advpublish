# Generated by Django 2.1.3 on 2018-11-21 15:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('area', models.ManyToManyField(blank=True, to='materials.Area')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Machine',
            fields=[
                ('title', models.CharField(blank=True, max_length=64, null=True, verbose_name='名称')),
